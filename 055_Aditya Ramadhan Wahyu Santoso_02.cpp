	...
	int main()
{
	...
	printf("\n");
	printf("Pedagang berada dikota (masukkan 1 data yang sama dengan u ) :\n");
	scanf("%d", &pedagang);
	
	//input lokasi kota yang diserang naga
	printf("\n");
	printf("Vertex yang diserang naga (masukkan 1 data yang sama u atau v) : \n");
	scanf("%d", &naga);
	
	//input lokasi kastil
	printf("\n");
	printf("Kastil raja (masukkan 1 data yang sama dengan v) : \n");
	scanf("%d", &kastil);
